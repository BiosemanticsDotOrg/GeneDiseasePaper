...
public class MapKEGGc2InChI {
	  public OntologyStore map(OntologyStore ontology, String mappingFile){
		    System.out.println("Loading ontology... ");
		    int longInchi = 0;
		    ReadTextFile mapFile = new ReadTextFile(mappingFile);
