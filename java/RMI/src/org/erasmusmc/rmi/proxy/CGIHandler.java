...
/*
 *  $Header: /cvs/jsdt/src/share/com/sun/media/jsdt/http/CGIHandler.java,v 1.3 2005/04/05 21:44:31 richburridge Exp $
 *
...
package org.erasmusmc.rmi.proxy;
...
class CGIClientException extends Exception {
  private static final long serialVersionUID = 6334112059305773099L;

    public 
    CGIClientException(String s) {
    super(s);
    }
}
...
class 
CGIServerException extends Exception {
  private static final long serialVersionUID = 7530419978993336120L;

    public 
    CGIServerException(String s) {
    super(s);
    }
}
...
interface CGICommandHandler {
     ...
     */
    public void 
    execute(String param) throws CGIClientException, CGIServerException;
}
...
CGIHandler {
    ...
    static int    ServerPort = Integer.getInteger("SERVER_PORT", 0).intValue();
 ...
 */
    ...
    private static void 
    returnClientError(String message) { 
    System.out.println("Status: 400 Bad Request: " + message);
    System.out.println("Content-type: text/html");
    System.out.println("");
    System.out.println("<HTML>" +
                       "<HEAD><TITLE>Java Erasmus MC Client Error" +
                       "</TITLE></HEAD>" +
                       "<BODY>");
    System.out.println("<H1>Java Erasmus MC Client Error</H1>");
    System.out.println("");
 ...
 */
    ...
    private static void 
    returnServerError(String message) { 
    System.out.println("Status: 500 Server Error: " + message);
    System.out.println("Content-type: text/html");
    System.out.println("");
    System.out.println("<HTML>" +
                       "<HEAD><TITLE>Java Erasmus MC Server Error" +
                       "</TITLE></HEAD>" +
                       "<BODY>");
    System.out.println("<H1>Java Erasmus MC Server Error</H1>");
    System.out.println("");
    System.out.println(message);
    System.out.println("</BODY></HTML>");
    System.exit(1);
...
final class 
CGIForwardCommand implements CGICommandHandler {
...
final class 
CGIGethostnameCommand implements CGICommandHandler {
...
final class 
CGIPingCommand implements CGICommandHandler {
...
final class 
CGITryHostnameCommand implements CGICommandHandler {
    ...
    System.out.println("");
    System.out.println("<HTML>" +
                       "<HEAD><TITLE>Java Erasmus MC Server Hostname Info" +
                       "</TITLE></HEAD>" +
                       "<BODY>");
    System.out.println("<H1>Java Erasmus MC Server Hostname Info</H1>");
