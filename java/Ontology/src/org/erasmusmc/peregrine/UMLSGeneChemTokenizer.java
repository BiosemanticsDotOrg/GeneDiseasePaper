...
public class UMLSGeneChemTokenizer  extends Tokenizer implements Serializable{
	...
	public UMLSGeneChemTokenizer(){
		super();
	}

	public UMLSGeneChemTokenizer(Tokenizer tokenizer) {
		super(tokenizer);
	}
