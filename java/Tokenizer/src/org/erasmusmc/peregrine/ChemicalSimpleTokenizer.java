...
public class ChemicalSimpleTokenizer extends Tokenizer{
  
  public ChemicalSimpleTokenizer(){
    super();
  }
  
  public ChemicalSimpleTokenizer(Tokenizer tokenizer) {
    super(tokenizer);
  }  
...
//          !StringUtilities.isGreekLetter(string) &&
//          !StringUtilities.isRomanNumeral(string) &&
          !(ch == '.') &&
          !(ch == ',') &&
          !(ch == '+') &&
          !(ch == ']') &&
